...
image: ./src/images/undraw_new_message_2gfk.png
image_title:
image_description:
...
![Avviso di impostazione di filtro di inoltro automatico in Gmail](./src/images/gmail-avviso-impostazione-filtro-di-inoltro.jpg 'Questo riquadro viene visualizzato quando qualcuno ha impostato un filtro per inoltrare automaticamente messaggi specifici')
...
![Icona impostazioni a forma di ingranaggio](./src/images/icona-impostazioni.png){.ml-8 .mt-0 .mb-6}
...
![Sezione Inoltro da cui è possibile impostare l'inoltro automatico dei messaggi](./src/images/gmail-impostazioni-inoltro-automatico.jpg "Se non avete impostato l'inotro automatico, quando accede a questa scheda compare il pulsante 'Aggiungi un indirizzo di inoltro'")**Se non avete impostato indirizzi di inoltro la sezione **Inoltro** dovrebbe comparire come in figura**
...
![Sezione Inoltro - Impostazioni per disattivare l'inoltro dei messaggi](./src/images/gmail-disattiva-inoltro-utilizzato-da-un-filtro.jpg "Controllate che sia selezionata l'opzione 'Disattiva inoltro'")
