...
![Gif che mostra come aprire un file Drive in un'applicazione desktop](/images/chrome-aprire-file-in-applicazione-desktop.gif "Ora puoi aprire i file che hai in Drive direttamente in un'applicazione desktop")
**Apri un file archiviato in Drive in un'applicazione desktop direttamente dal browser con pochi clic**
