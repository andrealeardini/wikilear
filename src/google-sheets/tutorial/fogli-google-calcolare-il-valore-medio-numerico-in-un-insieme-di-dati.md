...
{{ sheet.render(esempio) | trimHTML | safe }}
...
{{ sheet.render(media.se, on, 14, 17) | trimHTML | safe }}
...
{{ sheet.render(media.se, on, 19, 22) | trimHTML | safe }}
...
{{ sheet.render(settoriXarea, on, 16, 19) | trimHTML | safe }}
